...
public interface ActProxyAdministrator extends ActProxyAuthenticated {
	 ...
	 */
	public PtBoolean oeAddCoordinator(DtCoordinatorID aDtCoordinatorID, DtLogin aDtLogin,DtPassword aDtPassword, EtExperience aEtExperience, byte[] aFingerPrint) throws RemoteException, NotBoundException;
